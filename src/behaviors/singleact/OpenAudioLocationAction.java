 ...
 * @author Yuvi Masory
 */
public class OpenAudioLocationAction extends IdentifiedSingleAction {

	public static enum SelectionMode {FILES_ONLY, DIRECTORIES_ONLY}

	private SelectionMode mode;

	public OpenAudioLocationAction() {
	}

	public OpenAudioLocationAction(SelectionMode mode) {
		if(SysInfo.sys.useAWTFileChoosers == false) {
			throw new UnsupportedOperationException("this constructor is only for awt file dialog mode");
		}
		this.mode = mode;
	}
