 ...
 * @author Yuvi Masory
 */
public class KeyBindingsMessageAction extends IdentifiedSingleAction {

	private final String MENU;
	
	public KeyBindingsMessageAction() {
		MENU = SysInfo.sys.menuKeyString;
	}
	
	private String makeMessage() {
		StringBuffer out = new StringBuffer();
		 
		out.append("<html><b>NOTE: Most key bindings are given only in the program menu.</b>\n\n");
		
		out.append("Enter -- Commit text as normal annotation\n");
		out.append(MENU + " + Shift + Enter -- Commit text as intrusion\n");
		out.append(MENU + " + Backspace or Delete -- Delete selected annotation\n");
		out.append(MENU + " + P -- Another binding for play/pause, useful when the cursor is in the text field\n\n");
		
		out.append("Emacs key bindings can be used in the wordpool text field.\n\n");
